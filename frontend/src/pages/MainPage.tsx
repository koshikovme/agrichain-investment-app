    ...
    const features = [
        {
            ...
            title: t("main.features.blockchain"),
            desc: t("main.features.blockchainDesc"),
        },
        {
            icon: <SecurityIcon sx={{ fontSize: 40, color: "#388e3c" }} />,
            title: t("main.features.security"),
            desc: t("main.features.securityDesc"),
        },
        {
            icon: <SpeedIcon sx={{ fontSize: 40, color: "#fbc02d" }} />,
            title: t("main.features.fast"),
            desc: t("main.features.fastDesc"),
        },
        {
            icon: <EmojiEventsIcon sx={{ fontSize: 40, color: "#fbc02d" }} />,
            title: t("main.features.profit"),
            desc: t("main.features.profitDesc"),
        },
    ];
